            ...
            try
            {
                ...
                builder.Services.AddSingleton<IConnectionMultiplexer>(sp =>
                {
                    ...
                    var retryPolicy = Polly.Policy
                        ...
                        {
                            Log.Error($"Retrying Redis connection. Attempt {retryCount}. Error: {exception.Message}");
                        });
                ...
                builder.Services.AddSingleton<IElasticClient>(sp =>
                {
                    ...
                    var retryPolicy = Polly.Policy
                        ...
                        .WaitAndRetryAsync(5, retryAttempt => TimeSpan.FromSeconds(Math.Pow(2, retryAttempt)),
                            ...
                            {
                                Log.Error($"Attempt {retryCount} to connect to Elasticsearch failed. Error: {exception.Message}");
                            });
                    ...
                    {
                        Log.Error($"Elasticsearch connection failed after retries: {ex.Message}");
                    }
