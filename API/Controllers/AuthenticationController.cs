...
namespace API.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public AuthenticationController(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, MailService mailService, UserService userService, UserDetailService userDetailService)
        {
